...
public class WxCatalogController {
     ...
     * @return 所有分类数据
     */
    //todo 都没有使用缓存 和首页index 的情况一样 处理方式也可以一样
    @GetMapping("all")
    ...
    public Object getLevel1Category() {
        // 所有一级分类目录
        List<LitemallCategory> l1CatList = categoryService.queryL1();
        Map<String, Object> data = new HashMap<String, Object>();
        data.put("categoryList", l1CatList);
     ...
     * @return
     */
    @GetMapping("getLevel2Category")
    public Object getLevel2Category(@NotNull Integer id) {
        // 所有一级分类目录
        List<LitemallCategory> l2CatList = categoryService.queryByPid(id);
        Map<String, Object> data = new HashMap<String, Object>();
        data.put("subCategoryList", l2CatList);
        return ResponseUtil.ok(data);
    }
    ...
    public Object getHomeCategory() {
        // 所有一级分类目录
        List<LitemallCategory> l2CatList = categoryService.queryHomeCategory();
        Map<String, Object> data = new HashMap<String, Object>();
