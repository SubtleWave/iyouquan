...
public class AdminGoodsController {
    ...
    @PostMapping("/update")
    public Object update(@RequestBody GoodsAllinone goodsAllinone) throws IOException, SolrServerException {
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody LitemallGoods goods) throws IOException, SolrServerException {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody GoodsAllinone goodsAllinone) throws IOException, SolrServerException {
